#Weather Project Main directory
...
#store future file names in an object
output.folder.names <- c("Clean Folder", "Figures of interest", 
                         "Raw Data","Final R scripts","Potential Analysis",
                         "Relevant Analysis","Relevant Graphics",
                         "Potential Graphics","Useful R scripts")
...
path.potgraph<- paste(working.dir, "/", output.folder.names[8], "/", sep = "")
path.extr<- paste(working.dir, "/", output.folder.names[9], "/", sep = "")
